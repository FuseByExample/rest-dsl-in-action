...
----
+
. When the ApiMan gateway will recieve the requests, it will insert the information usign a local ElasticsSearch database. The `Review metrics` tab that 
  we have / service can allow us to check the completed or failed requests.
+
