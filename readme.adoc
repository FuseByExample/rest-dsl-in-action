...
and next forwarded to the real service or endpoint exposing the REST endpoint. To design it, we will create a service and specify the address of the service.
