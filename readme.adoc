...
----
+
. Next, you can refresh your index.html page within your browser and select the load button from the top menu bar in order to load the `fuse-demo` dashboard.
+
...
+
----
http http://localhost:9191/blog/article/search/user/1
----
+
.. Delete a user.
+
...
+
. Click on the +implementation+ link and add the Api endpoints +http://localhost:9191/blog/article+, select +REST+ for the +Api Type+ dropdown box.
