...
. As the platform generates a password, we will change it to use our own password. So, click on the `Credential` tab and encode your the `admin` password within the fields
