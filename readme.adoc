...
+
. We will now define 3 rules to map a path to a verb and a role by using the `Add Authorization Rule` section of the screen. Encode the information as defined within the following table
+
|===
