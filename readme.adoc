...
----
+
NOTE: Before to issue the HTTP GET request, you can change the content of the Blog Article that you will publish by editing the file `data/elasticsearch/entry.json`
+
