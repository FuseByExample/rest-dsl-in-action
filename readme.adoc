...
For the purpose of this demo, we have documented the REST Services using the http://swagger.io/[Swagger API]. The documentation is defined within the `swagger/src/main/resources/services.json` file of the swagger maven module.
